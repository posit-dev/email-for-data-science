...
def test_quarto_json_to_email_basic(tmp_path):
    ...
    assert result.email_supress_report_attachment is True
    assert result.email_supress_scheduled is False
...
def test_quarto_json_to_email_minimal(tmp_path):
    ...
    assert result.inline_attachments == {}
    assert result.email_supress_report_attachment is False
    assert result.email_supress_scheduled is False
